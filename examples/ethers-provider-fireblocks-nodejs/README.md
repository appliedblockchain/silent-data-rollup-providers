# Silent Data Fireblocks Node.js Example

This repository demonstrates how to interact with Silent Data using Node.js with Fireblocks integration using both `@appliedblockchain/silentdatarollup-core` and `@appliedblockchain/silentdatarollup-ethers-provider-fireblocks` packages.
